const defaults: Readonly<Record<string, string>> = {
  ...
  VFBIZ_CUSTOMER_OIDC_ISSUER:
    'http://127.0.0.1:8080/realms/vfbiz-customer',
  ...
  VFBIZ_CUSTOMER_OIDC_AUTHORIZED_PARTIES:
    'vfbiz-customer-bff,vfbiz-mobile',
  VFBIZ_WORKFORCE_OIDC_ISSUER:
    'http://127.0.0.1:8080/realms/vfbiz-workforce',
